...
router.get('/', function(req, res, next) {
    const data = {
        data: [
            {
                msg: "<p>Mitt namn är Emelie Åslund. Jag är 25år gammal. Född och uppvuxen i Ekerö, Stockholm. Jag gick på NTI-Gymnasiet där jag studerade spelprogrammering. För tillfället studerar jag samtidigt som jag jobbar på Lidl, där jag har jobbat sen 2013.</p> " +
